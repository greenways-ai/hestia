...
export const AGENT_RECORD_SCHEMAS = Object.freeze({
  ...
  "room/source-mandate": [
    ...
    ["room", "room_root", "reference"],
    ["governance", "governance_root", "reference"],
    ["issued-by", "issued_by_profile_root", "reference"],
    ...
    ["requires-user-interaction", "requires_user_interaction"],
    ["valid-from", "valid_from"],
    ["valid-until", "valid_until"]
  ],
  "room/source-mandate-revocation": [
    ...
    ["room", "room_root", "reference"],
    ["governance", "governance_root", "reference"],
    ["mandate", "mandate_root", "reference"],
    ["revoked-by", "revoked_by_profile_root", "reference"],
    ["authority", "authority_root", "reference"],
    ["reason", "reason"],
  ...
  "room/application-grant": [
    ...
    ["authority", "authority_root", "reference"],
    ["member-profile", "member_profile_root", "reference"],
    ["member-node", "member_node_id"],
    ["source-mandate", "source_mandate_root", "reference"],
    ["application", "application"],
    ["operations", "operations"],
    ["limits", "limits"],
    ["membership-epoch", "membership_epoch"],
